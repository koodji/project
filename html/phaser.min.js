...
function() {
	...
	return b.game = null, b.WEBGL_RENDERER = 0, b.CANVAS_RENDERER = 1, b.VERSION = "v2.2.9", b._UID = 0, "undefined" != typeof Float32Array ? (b.Float32Array = Float32Array, b.Uint16Array = Uint16Array, b.Uint32Array = Uint32Array, b.ArrayBuffer = ArrayBuffer) : (b.Float32Array = Array, b.Uint16Array = Array), b.PI_2 = 2 * Math.PI, b.RAD_TO_DEG = 180 / Math.PI, b.DEG_TO_RAD = Math.PI / 180, b.RETINA_PREFIX = "@2x", b.DisplayObject = function() {
		...
		d.colorMask(!1, !1, !1, !1), d.stencilFunc(d.ALWAYS, 0, 255), d.stencilOp(d.KEEP, d.KEEP, d.INVERT), 1 === b.mode ? (d.drawElements(d.TRIANGLE_FAN, b.indices.length - 4, d.UNSIGNED_SHORT, 0), this.reverse ? (d.stencilFunc(d.EQUAL, 255 - e, 255), d.stencilOp(d.KEEP, d.KEEP, d.DECR)) : (d.stencilFunc(d.EQUAL, e, 255), d.stencilOp(d.KEEP, d.KEEP, d.INCR)), d.drawElements(d.TRIANGLE_FAN, 4, d.UNSIGNED_SHORT, 2 * (b.indices.length - 4)), this.reverse ? d.stencilFunc(d.EQUAL, 255 - (e + 1), 255) : d.stencilFunc(d.EQUAL, e + 1, 255), this.reverse = !this.reverse) : (this.reverse ? (d.stencilFunc(d.EQUAL, e, 255), d.stencilOp(d.KEEP, d.KEEP, d.INCR)) : (d.stencilFunc(d.EQUAL, 255 - e, 255), d.stencilOp(d.KEEP, d.KEEP, d.DECR)), d.drawElements(d.TRIANGLE_STRIP, b.indices.length, d.UNSIGNED_SHORT, 0), this.reverse ? d.stencilFunc(d.EQUAL, e + 1, 255) : d.stencilFunc(d.EQUAL, 255 - (e + 1), 255)), d.colorMask(!0, !0, !0, !0),
			d.stencilOp(d.KEEP, d.KEEP, d.KEEP), this.count++
		...
		this.imageUrl ? (delete b.BaseTextureCache[this.imageUrl], delete b.TextureCache[this.imageUrl], this.imageUrl = null, navigator.isCocoonJS || (this.source.src = "")) : this.source && (b.CanvasPool.removeByCanvas(this.source), this.source._pixiId && delete b.BaseTextureCache[this.source._pixiId]), this.source = null, this.unloadFromGPU()
		...
		this.valid = a && a.width && a.height && this.baseTexture.source && this.baseTexture.hasLoaded, this.trim && (this.width = this.trim.width, this.height = this.trim.height, this.frame.width = this.trim.width,
	...
	function() {
		...
		window.console || (window.console = {}, window.console.log = window.console.assert = function() {}, window.console.warn = window.console.assert = function() {}), c.Utils = {
			...
			return void 0 === b && (b = !1), a.parent !== this && (a.body && a.parent && a.parent.hash && a.parent.removeFromHash(a), a.z = this.children.length, this.addChild(a), this.enableBody && null === a.body ? this.game.physics.enable(a, this.physicsBodyType) : a.body && this.addToHash(a), !b && a.events && a.events.onAddedToGroup$dispatch(a, this), null === this.cursor && (this.cursor = a)), a
			...
			return void 0 === c && (c = !1), a.parent !== this && (a.body && a.parent && a.parent.removeFromHash(a), this.addChildAt(a, b), this.updateZ(), this.enableBody && null === a.body ? this.game.physics.enable(a, this.physicsBodyType) : a.body && this.addToHash(a), !c && a.events && a.events.onAddedToGroup$dispatch(a, this), null === this.cursor && (this.cursor = a)), a
			...
			return f.exists = e, f.visible = e, f.alive = e, f.z = this.children.length, this.addChild(f), this.enableBody && this.game.physics.enable(f, this.physicsBodyType, this.enableBodyDebug), f.events && f.events.onAddedToGroup$dispatch(f, this), null === this.cursor && (this.cursor = f), f
			...
			checkPointerOver: function(a, b) {
				return a.isDown && this.enabled && this.sprite && this.sprite.parent && this.sprite.visible && !(!this.sprite.parent.visible | 0 === this.sprite.worldScale.x) && 0 !== this.sprite.worldScale.y && this.game.input.hitTest(this.sprite, a, this._tempPoint) ? (void 0 === b && (b = !1), !b && this.pixelPerfectOver ? this.checkPixel(this._tempPoint.x, this._tempPoint.y) : !0) : !1
			},
			...
			_pointerOverHandler: function(a) {
				if (null !== this.sprite) {
					...
					if (b.isOver === !1 || a.dirty) {
						var c = b.isOver === !1;
						b.isOver = !0, b.isOut = !1, b.timeOver = this.game.time.time, b.x = a.x - this.sprite.x, b.y = a.y - this.sprite.y, this.useHandCursor && b.isDragged === !1 && (this.game.canvas.style.cursor = "pointer", this._setHandCursor = !0), c && this.sprite && this.sprite.events && this.sprite.events.onInputOver$dispatch(this.sprite, a)
					}
				}
			},
			...
			_touchedHandler: function(a) {
				if (null !== this.sprite) {
					...
					if (!b.isDown && b.isOver) {
						...
						if (b.isDown = !0, b.isUp = !1, b.timeDown = this.game.time.time, a.dirty = !0, this.sprite && this.sprite.events && (this.sprite.events.onInputDown$dispatch(this.sprite, a), null === this.sprite)) return;
						this.draggable && this.isDragged === !1 && this.startDrag(a), this.bringToTop && this.sprite.bringToTop()
					}
				}
			},
			...
			startDrag: function(a) {
				...
				this.updateDrag(a, !0), this.bringToTop && (this._dragPhase = !0, this.sprite.bringToTop()), this.dragStartPoint.set(b, c), this.sprite.events.onDragStart$dispatch(this.sprite, a, b, c)
			},
		...
		c.Button.prototype.clearFrames = function() {
		...
		}, c.SpriteBatch.prototype = c.Utils.extend(!0, c.SpriteBatch.prototype, PIXI.SpriteBatch.prototype, c.Group.prototype), c.SpriteBatch.prototype.constructor = c.SpriteBatch, c.BitmapData = function(a, b, d, e) {
			(void 0 === d || 0 === d) && (d = 256), (void 0 === e || 0 === e) && (e = 256), this.game = a, this.key = b, this.width = d, this.height = e, this.canvas = PIXI.CanvasPool.create(this, d, e), this.context = this.canvas.getContext("2d", {
				alpha: !0
			}), this.ctx = this.context, this.imageData = this.context.getImageData(0, 0, d, e), this.data = null, this.imageData && (this.data = this.imageData.data), this.pixels = null, this.data && (this.imageData.data.buffer ? (this.buffer = this.imageData.data.buffer, this.pixels = new Uint32Array(this.buffer)) : window.ArrayBuffer ? (this.buffer = new ArrayBuffer(this.imageData.data.length), this.pixels = new Uint32Array(this.buffer)) : this.pixels = this.imageData.data), this.baseTexture = new PIXI.BaseTexture(this.canvas), this.texture = new PIXI.Texture(this.baseTexture), this.frameData = new c.FrameData, this.textureFrame = this.frameData.addFrame(new c.Frame(0, 0, 0, d, e, "bitmapData")), this.texture.frame = this.textureFrame, this.type = c.BITMAPDATA, this.disableTextureUpload = !1, this.dirty = !1, this.cls = this.clear, this._image = null, this._pos = new c.Point, this._size = new c.Point, this._scale = new c.Point, this._rotate = 0, this._alpha = {
				prev: 1,
				current: 1
			...
			drawGroupProxy: function(a, b, c) {
				if (a.hasOwnProperty("texture") && this.copy(a, null, null, null, null, a.worldPosition.x, a.worldPosition.y, null, null, a.worldRotation, null, null, a.worldScale.x, a.worldScale.y, a.worldAlpha, b, c), a.hasOwnProperty("children") && a.children.length > 0)
					for (var d, e = 0; e < a.children.length; e++) d = a.children[e], this.copy(d, null, null, null, null, d.worldPosition.x, d.worldPosition.y, null, null, d.worldRotation, null, null, d.worldScale.x, d.worldScale.y, a.worldAlpha, b, c)
			},
			...
			if (this.graphicsData.length)
				for (var f, g, h, i, j, k, l = 0; l < this.graphicsData.length; l++) {
					var m = this.graphicsData[l],
						n = m.type,
						o = m.lineWidth;
					if (f = m.shape, n === PIXI.Graphics.RECT || n === PIXI.Graphics.RREC) h = f.x - o / 2, i = f.y - o / 2, j = f.width + o, k = f.height + o, a = a > h ? h : a, b = h + j > b ? h + j : b, d = d > i ? i : d, e = i + k > e ? i + k : e;
			...
			if (e === i > 0)
				for (f = b; c > f; f += d) h = PIXI.EarCut.insertNode(f, a[f], a[f + 1], h);
			else
			...
			for (var h = 0; g > h; h++) {
				if (0 === c) {
					var i = this.context.measureText(b[h]).width + this.style.strokeThickness + this.padding.x;
					...
					if (Array.isArray(c))
						for (var k = 0, l = 0; l < j.length; l++) {
							var m = Math.ceil(this.context.measureText(j[l]).width);
							l > 0 && (k += c[l - 1]), i = k + m
						} else
		...
		}), c.Text.fontPropertiesCache = {}, c.Text.fontPropertiesCanvas = PIXI.CanvasPool.create(c.Text.fontPropertiesCanvas), c.Text.fontPropertiesContext = c.Text.fontPropertiesCanvas.getContext("2d"), c.BitmapText = function(a, b, d, e, f, g, h) {
			...
			for (var d = 0, e = 0, f = -1, g = null, h = this._maxWidth > 0 ? this._maxWidth : null, i = [], j = 0; j < c.length; j++) {
				...
				var l = c.charCodeAt(j),
					m = a.chars[l],
					n = 0;
				void 0 === m && (l = 32, m = a.chars[l]);
				var o = g && m.kerning[g] ? m.kerning[g] : 0;
				if (f = /(\s)/.test(c.charAt(j)) ? j : f, n = (o + m.texture.width + m.xOffset) * b, h && e + n >= h && f > -1) return {
					width: e,
					text: c.substr(0, j - (j - f)),
					end: k,
					chars: i
				};
				e += (m.xAdvance + o) * b, i.push(d + (m.xOffset + o) * b), d += (m.xAdvance + o) * b, g = l
			}
			return {
				width: e,
				text: c,
			...
			this.points = [], this.points = g, this._hasUpdateAnimation = !1, this._updateAnimationCallback = null, b = b || 0, d = d || 0, e = e || null, f = f || null, this.type = c.ROPE, PIXI.Rope.call(this, PIXI.TextureCache.__default, this.points), c.Component.Core.init.call(this, a, b, d, e, f)
			...
			create: function(a, b, c, d, e) {
				if (b = b || 256, c = c || 256, void 0 === e) var f = PIXI.CanvasPool.create(a, b, c);
				else var f = document.createElement("canvas");
		...
		return c.Math.degToRad = function(a) {
			...
			addDefaultImage: function() {
				...
				b.base.skipRender = !0, PIXI.TextureCache.__default = new PIXI.Texture(b.base)
			},
			...
			play: function(a, b, c, d, e) {
				...
				if (this._sound && this.isPlaying && !this.allowMultiple && (this.override || e))
					if (this.usingWebAudio) {
						...
						this.externalNode ? this._sound.disconnect(this.externalNode) : this._sound.disconnect(this.gainNode)
			...
			boot: function() {
				this.game.renderType === c.CANVAS ? this.context = this.game.context : (this.bmd = this.game.make.bitmapData(this.game.width, this.game.height), this.sprite = this.game.make.image(0, 0, this.bmd), this.game.stage.addChild(this.sprite), this.game.scale.onSizeChange.add(this.resize, this), this.canvas = PIXI.CanvasPool.create(this, this.game.width, this.game.height), this.context = this.canvas.getContext("2d"))
			},
			...
			inputInfo: function(a, b, c) {
				this.start(a, b, c), this.line("Input"), this.line("X: " + this.game.input.x + " Y: " + this.game.input.y), this.line("World X: " + this.game.input.worldX + " World Y: " + this.game.input.worldY), this.line("Scale X: " + this.game.input.scale.x.toFixed(1) + " Scale Y: " + this.game.input.scale.x.toFixed(1)), this.line("Screen X: " + this.game.input.activePointer.screenX + " Screen Y: " + this.game.input.activePointer.screenY),
					this.stop()
			},
			...
			computeVelocity: function(a, b, c, d, e, f) {
				return void 0 === f && (f = 1e4), 1 === a && b.allowGravity ? c += (this.gravity.x + b.gravity.x) * this.game.time.physicsElapsed : 2 === a && b.allowGravity && (c += (this.gravity.y + b.gravity.y) * this.game.time.physicsElapsed), d ? c += d * this.game.time.physicsElapsed : e && (e *= this.game.time.physicsElapsed, c - e > 0 ? c -= e : 0 > c + e ? c += e : c = 0), c > f ? c = f : -f > c && (c = -f), c
			},
			...
			collideSpriteVsGroup: function(a, b, d, e, f, g) {
				if (0 !== b.length && a.body) {
					...
					if (this.skipQuadTree || a.body.skipQuadTree) {
						for (var i = 0; i < b.hash.length; i++)
							if (b.hash[i] && b.hash[i].exists && b.hash[i].body) {
						...
						for (var j = this.quadTree.retrieve(a), i = 0; i < j.length; i++) this.separate(a.body, j[i], e, f, g) && (d && d.call(f, a, j[i].sprite), this._total++)
					}
				}
			},
					...
					for (var g = 0; g < a.hash.length; g++)
						if (a.hash[g] && a.hash[g].exists && a.hash[g].body)
							for (var h = a.hash[g], i = g + 1; i < a.hash.length; i++)
								if (a.hash[i] && a.hash[i].exists && a.hash[i].body) {
									var j = a.hash[i];
			...
			separate: function(a, b, c, d, e) {
				...
				var f = !1,
					g = !1;
				return this.forceX || Math.abs(this.gravity.y + a.gravity.y) < Math.abs(this.gravity.x + a.gravity.x) ? (f = this.separateX(a, b, e), this.intersects(a, b) && (g = this.separateY(a, b, e))) : (g = this.separateY(a, b, e), this.intersects(a, b) && (f = this.separateX(a, b, e))), f || g
			},
			...
			this.sprite = a, this.game = a.game, this.type = c.Physics.ARCADE, this.enable = !0, this.offset = new c.Point, this.position = new c.Point(a.x, a.y), this.prev = new c.Point(this.position.x, this.position.y), this.allowRotation = !0, this.rotation = a.rotation, this.preRotation = a.rotation, this.width = a.width, this.height = a.height, this.sourceWidth = a.width, this.sourceHeight = a.height, a.texture && (this.sourceWidth = a.texture.frame.width, this.sourceHeight = a.texture.frame.height), this.halfWidth = Math.abs(a.width / 2), this.halfHeight = Math.abs(a.height / 2), this.center = new c.Point(a.x + this.halfWidth, a.y + this.halfHeight), this.velocity = new c.Point, this.newVelocity = new c.Point(0, 0), this.deltaMax = new c.Point(0, 0), this.acceleration = new c.Point, this.drag = new c.Point, this.allowGravity = !0, this.gravity = new c.Point(0, 0), this.bounce = new c.Point, this.worldBounce = null, this.maxVelocity = new c.Point(1e4, 1e4), this.friction = new c.Point(1, 0), this.angularVelocity = 0, this.angularAcceleration = 0, this.angularDrag = 0, this.maxAngular = 1e3, this.mass = 1, this.angle = 0, this.speed = 0, this.facing = c.NONE, this.immovable = !1, this.moves = !0, this.customSeparateX = !1, this.customSeparateY = !1, this.overlapX = 0, this.overlapY = 0, this.embedded = !1, this.collideWorldBounds = !1, this.checkCollision = {
				...
				left: !1,
				right: !1
			}, this.tilePadding = new c.Point, this.dirty = !1, this.skipQuadTree = !1, this.syncBounds = !1, this._reset = !0, this._sx = a.scale.x, this._sy = a.scale.y, this._dx = 0, this._dy = 0
			...
			checkWorldBounds: function() {
				...
				a.x < b.x && c.left ? (a.x = b.x, this.velocity.x *= d, this.blocked.left = !0) : this.right > b.right && c.right && (a.x = b.right - this.width, this.velocity.x *= d, this.blocked.right = !0), a.y < b.y && c.up ? (a.y = b.y, this.velocity.y *= e, this.blocked.up = !0) : this.bottom > b.bottom && c.down && (a.y = b.bottom - this.height, this.velocity.y *= e, this.blocked.down = !0)
			},
			...
			reset: function(a, b) {
				this.velocity.set(0), this.acceleration.set(0), this.speed = 0, this.angularVelocity = 0, this.angularAcceleration = 0, this.position.x = a - this.sprite.anchor.x * this.sprite.width + this.offset.x, this.position.y = b - this.sprite.anchor.y * this.sprite.height + this.offset.y, this.prev.x = this.position.x, this.prev.y = this.position.y, this.rotation = this.sprite.angle, this.preRotation = this.rotation, this._sx = this.sprite.scale.x, this._sy = this.sprite.scale.y, this.center.setTo(this.position.x + this.halfWidth, this.position.y + this.halfHeight)
			},
			...
			void 0 === d && (d = !0), c = c || "rgba(0,255,0,0.4)", d ? (a.fillStyle = c, a.fillRect(b.position.x - b.game.camera.x, b.position.y - b.game.camera.y, b.width, b.height)) : (a.strokeStyle = c, a.strokeRect(b.position.x - b.game.camera.x, b.position.y - b.game.camera.y, b.width, b.height))
			...
			collideSpriteVsTilemapLayer: function(a, b, c, d, e, f) {
				if (a.body) {
					...
					if (0 !== g.length)
						for (var h = 0; h < g.length; h++) d ? d.call(e, a, g[h]) && this.separateTile(h, a.body, g[h], f) && (this._total++, c && c.call(e, a, g[h])) : this.separateTile(h, a.body, g[h], f) && (this._total++, c && c.call(e, a, g[h]))
				}
			},
			...
			separateTile: function(a, b, c, d) {
				...
				var e = 0,
					...
					g = 0,
					h = 1;
				if (b.deltaAbsX() > b.deltaAbsY() ? g = -1 : b.deltaAbsX() < b.deltaAbsY() && (h = -1), 0 !== b.deltaX() && 0 !== b.deltaY() && (c.faceLeft || c.faceRight) && (c.faceTop || c.faceBottom) && (g = Math.min(Math.abs(b.position.x - c.right), Math.abs(b.right - c.left)), h = Math.min(Math.abs(b.position.y - c.bottom), Math.abs(b.bottom - c.top))), h > g) {
			...
			processTileSeparationX: function(a, b) {
				0 > b ? a.blocked.left = !0 : b > 0 && (a.blocked.right = !0), a.position.x -= b, 0 === a.bounce.x ? a.velocity.x = 0 : a.velocity.x = -a.velocity.x * a.bounce.x
			},
			processTileSeparationY: function(a, b) {
				0 > b ? a.blocked.up = !0 : b > 0 && (a.blocked.down = !0), a.position.y -= b, 0 === a.bounce.y ? a.velocity.y = 0 : a.velocity.y = -a.velocity.y * a.bounce.y
			}
			...
			setupWall: function(a, b, c, d, e, f) {
				a ? this.walls[b] ? this.walls[b].position = [this.pxmi(c), this.pxmi(d)] : (this.walls[b] = new p2.Body({
					...
					angle: e
				}), this.walls[b].addShape(new p2.Plane), f && (this.walls[b].shapes[0].collisionGroup = this.boundsCollisionGroup.mask), this.world.addBody(this.walls[b])) : this.walls[b] && (this.world.removeBody(this.walls[b]), this.walls[b] = null)
			},
			pause: function() {
				this.paused = !0
			},
			...
			void 0 === f && (f = Number.MAX_VALUE), void 0 === g && (g = null), this.game = a.game, this.world = a, c = [a.pxmi(c[0]), a.pxmi(c[1])], e = [a.pxmi(e[0]), a.pxmi(e[1])],
			...
			parseTiledJSON: function(a) {
				...
				d.layers = e;
				for (var u = [], f = 0; f < a.layers.length; f++)
				...
				for (var x = [], y = [], f = 0; f < a.tilesets.length; f++) {
					...
					if (z.image) {
						...
						for (var C in z.tiles) {
							var w = z.tiles[C].image,
								p = z.firstgid + parseInt(C, 10);
							B.addImage(p, w)
						}
						y.push(B)
					}
				...
				for (var D = {}, E = {}, f = 0; f < a.layers.length; f++)
					if ("objectgroup" === a.layers[f].type) {
						var F = a.layers[f];
						D[F.name] = [], E[F.name] = [];
						for (var G = 0, i = F.objects.length; i > G; G++)
							if (F.objects[G].gid) {
								var H = {
									gid: F.objects[G].gid,
								...
								F.objects[G].rotation && (H.rotation = F.objects[G].rotation), D[F.name].push(H)
							...
							F.objects[G].rotation && (H.rotation = F.objects[G].rotation), H.polyline = [];
							for (var I = 0; I < F.objects[G].polyline.length; I++) H.polyline.push([F.objects[G].polyline[I].x, F.objects[G].polyline[I].y]);
							E[F.name].push(H), D[F.name].push(H)
						} else if (F.objects[G].polygon) {
							var H = b(F.objects[G], ["name", "type", "x", "y", "visible", "rotation", "properties"]);
							H.polygon = [];
							for (var I = 0; I < F.objects[G].polygon.length; I++) H.polygon.push([F.objects[G].polygon[I].x, F.objects[G].polygon[I].y]);
							D[F.name].push(H)
						} else if (F.objects[G].ellipse) {
							var H = b(F.objects[G], ["name", "type", "ellipse", "x", "y", "width", "height", "visible", "rotation", "properties"]);
							D[F.name].push(H)
						} else {
							var H = b(F.objects[G], ["name", "type", "x", "y", "width", "height", "visible", "rotation", "properties"]);
							H.rectangle = !0, D[F.name].push(H)
						}
					}
				d.objects = D, d.collision = E, d.tiles = [];
				for (var f = 0; f < d.tilesets.length; f++)
					for (var z = d.tilesets[f], q = z.tileMargin, J = z.tileMargin, K = 0, L = 0, M = 0, t = z.firstgid; t < z.firstgid + z.total && (d.tiles[t] = [q, J, f], q += z.tileWidth + z.tileSpacing, K++, K !== z.total) && (L++, L !== z.columns || (q = z.tileMargin, J += z.tileHeight + z.tileSpacing, L = 0, M++, M !== z.rows)); t++);
				for (var l, N, O, z, f = 0; f < d.layers.length; f++) {
					l = d.layers[f];
					for (var k = 0; k < l.data.length; k++) {
						r = l.data[k];
						for (var P = 0; P < r.length; P++) N = r[P], null === N || N.index < 0 || (O = d.tiles[N.index][2], z = d.tilesets[O], z.tileProperties && z.tileProperties[N.index - z.firstgid] && (N.properties = c.Utils.mixin(z.tileProperties[N.index - z.firstgid], N.properties)))
					}
				}
				return d
			}
